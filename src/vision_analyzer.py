...
class VisionAnalysisResult:
    ...
    category: str = ""            # 开发创作|阅读浏览|沟通协作|复盘分析|会议讨论|设计绘图|研究学习|社交沟通|娱乐休闲|其他|未分类
...
## JSON 结构（严格按此格式输出）
{
  ...
  "category": "严格从以下10选1：开发创作|阅读浏览|沟通协作|复盘分析|会议讨论|设计绘图|研究学习|社交沟通|娱乐休闲|其他",
...
## 10个分类
- 开发创作: 写代码/修复bug/写文档/做PPT/画图/P图/写邮件/剪视频
- 阅读浏览: 看网页/读PDF/浏览文档/查资料/刷信息流
- 沟通协作: 聊天/视频通话/在线会议/评论讨论/协同编辑
- 复盘分析: 审查日志/检查更新/分析统计数据/做报表/跑脚本/调试
- 会议讨论: Zoom/Teams/腾讯会议/飞书等视频会议
- 设计绘图: Figma/PS/AI/CAD/白板/思维导图/流程图
- 研究学习: 看教程/听课/读论文/读教科书/做笔记/背单词/做题
- 社交沟通: 微信聊天/技术讨论/开会
- 娱乐休闲: 视频/游戏/音乐/社交媒体/购物 → is_productive=false
- 其他: 系统设置/文件管理/终端操作等无法归类的活动

## 要点
- activity 和 detail 必须包含截图中的实质性内容：文字标题、概念名称、文件名、代码中的类名/函数名、数据字段名等
- category 必须严格用上面10个值，不能自创。不确定用"其他"
- 研究学习类同样要具体：提取学科、知识点、材料名、学习方式
